...
[`boards/cc1101-mini/`](boards/cc1101-mini/) is a complete, hand-finished
design package in this tool's format: an 18.5 x 12.6 mm, 4-layer TI CC1101
433 MHz module, **placed and fully routed** (0 DRC errors), with Gerbers,
pick-and-place, and a script that regenerates the board. Unlike
`export-kicad`'s grid placement, its layout is generated by a board-specific
script (`boards/cc1101-mini/pcb/gen_board.py`) using KiCad 7's `pcbnew` API.
